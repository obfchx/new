...
local Tabs = {
    Main = Window:AddTab({ Title = "Tab Chính", Icony = "home" }),
    Stats = Window:AddTab({ Title = "Tab Chỉ số", Icony = "plus-circle" }),
    Player = Window:AddTab({ Title = "Tab Người chơi", Icony = "baby" }),
    Teleport = Window:AddTab({ Title = "Tab Tele đảo", Icony = "palmtree" }),
    Fruit = Window:AddTab({ Title = "Tab Trái", Icony = "cherry" }),
    Raid = Window:AddTab({ Title = "Tab Tập kích", Icony = "swords" }),
    Race = Window:AddTab({ Title = "Tab Tộc V4", Icony = "chevrons-right" }),
    Shop = Window:AddTab({ Title = "Tab Cửa hàng", Icony = "shopping-cart" }),
	  Misc = Window:AddTab({ Title = "Tab Khác", Icon = "list-plus" }),
    Hop = Window:AddTab({ Title = "Tab Đổi sever", Icony = "user" }),
    Setting = Window:AddTab({ Title = "Tab Cài đặt", Icony = "settings" }),
}
...
ImageButton.Image = "rbxassetid://16795664136"
